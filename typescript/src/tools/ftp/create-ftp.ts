...
import { serviceUsernameSchema, passwordSchema, safePathSchema, quotaSchema, sanitizeToolError } from "../../validators.js";

const schema = z.object({
  user: serviceUsernameSchema.describe("FTP username"),
  pass: passwordSchema.describe("FTP password"),
  homedir: safePathSchema.optional().describe("Home directory for the FTP account"),
